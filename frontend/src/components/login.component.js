...
window.location = "/employeeAdmin/dashboard";   
          }
          else{
         ...
         <div>
          <nav className="navbar navbar-expand-lg navbar-light fixed-top">
            <div className="container">
              <Link className="navbar-brand" to={"/sign-in"} style= {{color : "#000000"}}>LinkIn</Link>
                    <Link className="nav-link ml-auto" to={"/sign-in"} style= {{color : "#000000"}}>Login</Link>
                    <Link className="nav-link" to={"/sign-up"} style= {{color : "#000000"}}>Sign up</Link>
